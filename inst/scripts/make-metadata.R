...
infoString = c("BADEA", "BALAGURANATH" ,"CHEN", "COLLISON", "GRUTZMANN", "ICGCSEQ", "ICGCMICRO",
               ...
               "UNC", "WINTER", "ZHANG", "HAMIDI","YANG", "LUNARDI", "JANKY", "BAUER", "HAIDER", "VANDENBROECK")
...
main.data <- data.frame(
  ...
  Description = paste(
    ...
    c(
      ...
      "used in, Van den Broeck A et al. J Exp Clin Cancer Res 2012"
    )
  ),
  RDataPath = c(
  ...
  Genome=c("Affymetrix Human Genome U133 Plus 2.0 Array", "Human 1A Microarray G4110A-G4110B", "Affymetrix,Rosetta-Merck RSTA Custom 2.0", "Affymetrix, array U133 Plus 2.0","Affymetrix GeneChip Human Genome HG-U133B",
           ...
           "Affymetrix Human Genome U219 Array", "Illumina human WG6 Expression BeadChip", "Affymetrix Human Exon 1.0 ST Array", "Affymetrix, array U133 Plus 2.0"
  ),
  SourceType="RData",
  SourceUrl=c("https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=gse15471", "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE11838",
              ...
              "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE56560", "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE42952"),
  SourceVersion="July 09 2018",
  Species="Homo sapien",
  TaxonomyId=9606,
  Coordinate_1_based=FALSE,
  DataProvider=c(rep("GEO", 4), "Array Express", rep("ICGC", 2), rep("GEO", 2), "Private", "GEO", "GDC", "GEO", "Array Express", "GEO", rep("GEO", 4), "Array Express", "GEO", "GEO"),
