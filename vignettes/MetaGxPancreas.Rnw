...
This information is available for 12 of the 16 datasets.
...
esets = MetaGxOvarian::loadPancreasEsets()[[1]]
@

This will load 16 expression datasets. Users can modify the parameters of the function to restrict datasets that do not meet certain criteria for loading. Some example parameters are shown below:
